...
class EnhancedAnalyticsEngine:
    ...
    def _generate_performance_charts(self, df: pd.DataFrame, metrics: Dict[str, Any]) -> List[str]:
        ...
        if 'success_rate_by_area' in metrics:
            ...
            plt.tight_layout()
            chart_path = '/home/ubuntu/ai_improvements/analytics/success_rate_by_area.png'
        ...
        if 'monthly_volume' in metrics:
            ...
            plt.tight_layout()
            chart_path = '/home/ubuntu/ai_improvements/analytics/monthly_volume.png'
            plt.savefig(chart_path, dpi=300, bbox_inches='tight')
            plt.close()
            charts.append(chart_path)
        ...
        if 'revenue_by_area' in metrics:
            ...
            plt.tight_layout()
            chart_path = '/home/ubuntu/ai_improvements/analytics/revenue_by_area.png'
            plt.savefig(chart_path, dpi=300, bbox_inches='tight')
            plt.close()
            charts.append(chart_path)
    ...
    def _generate_predictive_charts(self, df: pd.DataFrame, metrics: Dict[str, Any]) -> List[str]:
        ...
        if 'volume_prediction' in metrics:
            ...
            plt.tight_layout()
            chart_path = '/home/ubuntu/ai_improvements/analytics/volume_prediction.png'
            plt.savefig(chart_path, dpi=300, bbox_inches='tight')
            plt.close()
            charts.append(chart_path)
    ...
    def _generate_financial_charts(self, df: pd.DataFrame, metrics: Dict[str, Any]) -> List[str]:
        ...
        if 'monthly_revenue' in metrics:
            ...
            plt.tight_layout()
            chart_path = '/home/ubuntu/ai_improvements/analytics/monthly_revenue.png'
            plt.savefig(chart_path, dpi=300, bbox_inches='tight')
            plt.close()
            charts.append(chart_path)
